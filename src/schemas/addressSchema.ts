...
import {
  ...
  CEP_LENGTH,
} from "../constants/addressValidation";
...
export const addressSchema = z.object({
  ...
  street: z.string().min(1, ADDRESS_VALIDATION_MESSAGES.STREET.REQUIRED),

  number: z.string().min(1, ADDRESS_VALIDATION_MESSAGES.NUMBER.REQUIRED),
  ...
  city: z.string().min(1, ADDRESS_VALIDATION_MESSAGES.CITY.REQUIRED),
